...
//add
//底栏新增待改动
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber delegate:(id<TZImagePickerControllerDelegate>)delegate pushPhotoPickerVc:(BOOL)pushPhotoPickerVc andShowPerview:(BOOL)show{
    _showBottomPreview = show;
    _pushPhotoPickerVc = pushPhotoPickerVc;
    TZAlbumPickerController *albumPickerVc = [[TZAlbumPickerController alloc] init];
    albumPickerVc.columnNumber = columnNumber;
    self = [super initWithRootViewController:albumPickerVc];
    if (self) {
        ...
        self.columnNumber = columnNumber;
        //bridge
        self.showBottomPreview = _showBottomPreview;
        albumPickerVc.showBottomPreview = _showBottomPreview;
...
- (void)pushPhotoPickerVc {
    ...
    if (!_didPushPhotoPickerVc && _pushPhotoPickerVc) {
        ...
        if (_showBottomPreview) {
            photoPickerVc.showBottomPreview = _showBottomPreview;
        }
        __weak typeof (self)weself = self;
        [photoPickerVc setPushImageToOthers:^(UIImage *image) {
            weself.pushImageToOthers(image);
        }];
    }
